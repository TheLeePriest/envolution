...
export const lambdaHandler = async (_event: Record<string, unknown>) => {
  ...
  console.log(`Processing with table: ${tableName}, bucket: ${bucketName}, timeout: ${timeout}s`);
...
const microserviceSchema = mergeSchemas(BaseEnvironmentSchema, MicroserviceSchema);
const microserviceEnv = createEnvironmentConfig(microserviceSchema);

// Service initialization
// biome-ignore lint/correctness/noUnusedVariables: This is a real-world usage example
class UserService {
