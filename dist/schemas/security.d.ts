...
export declare const SecurityEnvironmentSchema: z.ZodObject<{
    ...
    ENCRYPTION_ALGORITHM: z.ZodDefault<z.ZodEnum<["AES-256-GCM", "AES-256-CBC"]>>;
    CORS_ORIGIN: z.ZodOptional<z.ZodString>;
    CORS_CREDENTIALS: z.ZodDefault<z.ZodPipeline<z.ZodEffects<z.ZodString, boolean, string>, z.ZodBoolean>>;
    ...
    SECURITY_HEADERS_ENABLED: z.ZodDefault<z.ZodPipeline<z.ZodEffects<z.ZodString, boolean, string>, z.ZodBoolean>>;
    HSTS_MAX_AGE: z.ZodDefault<z.ZodPipeline<z.ZodEffects<z.ZodString, number, string>, z.ZodNumber>>;
}, "strip", z.ZodTypeAny, {
