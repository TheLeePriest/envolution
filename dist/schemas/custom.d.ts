...
export declare function mergeSchemas<T extends z.ZodRawShape, U extends z.ZodRawShape>(
  schema1: z.ZodObject<T>,
  schema2: z.ZodObject<U>
): z.ZodObject<T & U>;
export declare function createEnvironmentConfig<T extends z.ZodRawShape>(
  schema: z.ZodObject<T>,
